...
export const userInVerificationFlow = writable(localStorage.getItem("userInVerificationFlow") || "");
...
userInVerificationFlow.subscribe(val => localStorage.setItem("userInVerificationFlow", val));
