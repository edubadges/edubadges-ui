...
<style global lang="css">
    ...
    section {
        ...
        &.section-bewaren {
            background:
                no-repeat url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='-700 0 4000 100' fill='none'><path d='M -700 0.5 H 571 q 50 0 50 50 V 235 q 0 50 50 50 H 5000' stroke='%23772583' stroke-opacity='0.5'/></svg>") bottom center / 4000px auto,
        ...
        &.section-hand {
            overflow: hidden;
            background:
                no-repeat url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='-700 120 4000 300' fill='none'><path d='M -700 0.5 H 571 q 50 0 50 50 V 235 q 0 50 50 50 H 5000' stroke='%23772583' stroke-opacity='0.5'/></svg>") top center / 4000px auto,
                no-repeat url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 50 18' fill='none'><path d='M 0 12 C 25 8, 30 20, 50 8 S 60 8, 100 12 V 0 H 0 Z' fill='white' /></svg>") center / cover,
                #F6F0F9;

            @media (max-width: 1000px) {
                /* Remove line background */
                background:
                    no-repeat url("data:image/svg+xml,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 50 20' fill='none'><path d='M 0 12 C 25 8, 30 20, 50 8 S 60 8, 100 12 V 0 H 0 Z' fill='white' /></svg>") center / cover,
                    #F6F0F9;
            }
        }
        ...
        & > article {
            ...
            & #image-backpack {
                aspect-ratio: auto 1366 / 1201;
            }

            & #image-badge {
                aspect-ratio: auto 1366 / 1234;
            }

            & #image-portal {
                aspect-ratio: auto 1280 / 902;
                border-radius: 24px;
    ...
    <main>
        <section class="section-bewaren">
            <article>
                <article>
                    <h2>
                        {@html I18n.t('landing.bewaren.title')}
                    </h2>
                    <p>
        ...
        <section class="section-hand">
            ...
            <article>
                <article>
                    <h2>
                        {@html I18n.t('landing.hand.title')}
                    </h2>
                    <p>
                ...
                <img id="image-badge" alt="Details van een Edubadge in de mobiele app" src={app_badge}>
            </article>
        </section>
        <section class="section-portal">
            <article>
                <article>
                    <h2>
                        {@html I18n.t('landing.portal.title')}
                    </h2>
                    <p>
                ...
                <img id="image-portal" alt="Overzicht van de issuerportal" src={portal}>
            </article>
        </section>
    </main>
