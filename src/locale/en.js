...
I18n.translations.en = {
    ...
    models: {
        ...
        badgeclass: {
            ...
            info: {
                ...
                eqf: "Check <a target='_blank' rel='noreferrer' href='https://www.nlqf.nl/impact-nlqf/nlqf-niveaus-waaier/'>https://www.nlqf.nl/impact-nlqf/nlqf-niveaus-waaier/</a> for help",
                ects: "Whole and half points only. Valid value between 0.5 and 240 points.",
                ectsMicroCredentials: "Whole and half points only. Valid value between {{ectsMinimal}} and 30 points.",
    ...
    publicBadge: {
        ...
        validations: {
            ...
            issuedOn: "Issued on <strong>{{val}}</strong>",
            institution: "From institution <strong>{{val}}</strong>",
            faculty: "By <strong>{{val}}</strong>",
            issuedBy: "Issued by <strong>{{val}}</strong>",
            issuedUsing: "Issued using {{val}}",
            expiresOn: "Expires on <strong>{{val}}</strong>",
            holderName: "Name of the holder <strong>{{val}}</strong>",
            holderNameVerification: "Name of the holder is {{val}}",
            holderNameValidated: "verified",
            holderNameNotValidated: "not verified",
