...
I18n.translations.en = {
    ...
    student: {
        ...
        confirmation: {
            ...
            publishEvidenceConfirmation: "Add evidence/personal message (evidence) also to publicly available information.",
    ...
    models: {
        ...
        badgeclass: {
            ...
            created: "Created",
            issuedBy: "Issued by",
            onBehalfOf: "Issued on behalf of {{name}}",
            of: "of",
            admin: "Admin",
            ...
            evidenceRequired: "Evidence (URL) required",
    ...
    publicBadge: {
        ...
        noValidatedName: "This edubadge was issued to {{name}} whose name was <strong>not</strong> validated by an Institution on {{date}}",
    ...
    insights: {
        ...
        tooltips: {
            ...
            revoked: "Awarded badges that has been revoked by the teacher and as such are no longer valid",
            revokedBefore: "Direct awards that have been revoked by a teacher and as such have not been awarded the student",
