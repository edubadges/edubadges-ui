...
I18n.translations.nl = {
  ...
  manage: {
    ...
    delete: {
      ...
      info: {
        ...
        faculty: "Faculteit bevat issuers en kan niet verwijderd worden.",
  ...
  error: {
    ...
    214: "Je kunt niets annpassen, edubadges zijn al uitgegeven binnen deze entiteit.",
  ...
  editUsers: {
    ...
    roles: {
      institution_staff: "Instellings admin",
