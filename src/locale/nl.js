...
I18n.translations.nl = {
    ...
    models: {
        ...
        badgeclass: {
            ...
            eqf: "(Indicatief) EQF/NLQF niveau",
    ...
    tooltips: {
        ...
        demoEnvironment: "Alle data wordt iedere deployment verwijderd",
        directAwards:
    ...
    catalog: {
        ...
        eqf: {
            eqfNone: "Geen EQF/NLQF niveau",
            eqf: "EQF/NLQF niveau {{level}}",
        },
        badgeClassType: {
            ARCHIVED: "Gearchiveerd",
            ALL: "Alle",
    ...
    badgeAward: {
        directAward: {
            ...
            subtitle:
                "Je verzoek zal worden verzonden en je krijgt een melding wanneer het is geaccepteerd of geweigerd.",
        ...
        bulkAward: {
            ...
            details: {
                ...
                status: "Status",
                info: "De identificatie voor deze direct award bundle is de student {{identifier}}",
                eppn: "ID (EPPN)",
                email: "e-mail",
            },
        },
    ...
    newBadgeClassForm: {
        ...
        form: {
            ...
            eqfNlqfLevelVerified: "EQF/NLQF niveau vastgesteld",
