<script>
    ...
    $: showCloseButton = $userInVerificationFlow === true || $userInVerificationFlow === "true" ? true : false;
...
<div class="account-welcome">
    ...
    <div class="left">
      {#if activeStep === 2}
          ...
          <p class="info">{@html I18n.t("login.createEduId.infoStep2")}</p>
      {:else}
    ...
    <div class="right">
        <AccountCreationSteps activeStep={activeStep}/>
      {#if activeStep === 2}
          <Button className="full" onClick={stepUp}
