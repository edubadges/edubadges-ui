...
-   Merge pull request #176 from edubadges/bug/public-assertion-in-collection
-   Re-formatted exported variables
-   Merge pull request #175 from edubadges/dependabot/npm_and_yarn/sha.js-2.4.12
-   Link in public collections is to badgeclass See https://trello.com/c/NxxXK0bo
-   Merge pull request #173 from edubadges/feature/remove-imported-badge-functionality
-   build(deps): bump sha.js from 2.4.11 to 2.4.12
-   Merge pull request #161 from edubadges/dependabot/npm_and_yarn/form-data-3.0.4
-   Merge pull request #168 from edubadges/dependabot/npm_and_yarn/js-yaml-3.14.2
-   Merge pull request #169 from edubadges/dependabot/npm_and_yarn/node-forge-1.3.2
-   Fixes XSS on "you do not have access" page See https://trello.com/c/cRYVWsx8/1131-xss-on-you-do-not-have-access-page
-   Fixes https://trello.com/c/W4o0VLeC/1132-remove-imported-badge-functionality
